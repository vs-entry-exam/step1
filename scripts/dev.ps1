...
if ($All) {
  ...
  Start-Process -FilePath $shell -ArgumentList '-NoExit','-Command',$backendCmd | Out-Null
  Start-Process -FilePath $shell -ArgumentList '-NoExit','-Command',$frontendCmd | Out-Null
